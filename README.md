...
```bash
pip uninstall jupyter_tracking
```
...
# Change directory to the jupyter_tracking directory
...
folder is located. Then you can remove the symlink named `jupyter_tracking` within that folder.
